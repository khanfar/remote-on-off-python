...
import psutil
import json
import fcntl  # Import fcntl for file-based locking on Unix-like systems
import platform
import errno  # Import errno for error number codes

app = Flask(__name__)

TOKEN = '189xx656:AAH-s2qxUY-pSjxxxUGRsf12o_c'  # Replace with your bot token
